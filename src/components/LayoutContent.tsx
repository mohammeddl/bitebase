          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/search" className="hover:text-amber-500 transition-colors">Browse Recipes</Link></li>
                <li><Link href="/search" className="hover:text-amber-500 transition-colors">Categories</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/contact" className="hover:text-amber-500 transition-colors">FAQ</Link></li>
                ...
                <li><Link href="/terms-of-service" className="hover:text-amber-500 transition-colors">Terms of Service</Link></li>
              </ul>
            </div>
            <div>
